export default async function handler(req, res) {
  ...
  const REGEN_KEYWORDS = [
    // Professions sought
    'architect', 'architectural', 'landscape architect', 'urban designer',
    'masterplanner', 'masterplanning', 'urban design', 'placemaking',
    'planning consultant', 'planning consultancy', 'design team',
    'development partner', 'development management', 'project manager',
    // Place types
  ...
  try {
    ...
    const params = `updatedFrom=${since}&updatedTo=${until}&limit=100`;
